...
const DEFAULT_OG_ALT =
  "Your AI Worker - Productierijpe AI-agents voor Nederlandse bedrijven";
...
const CONTACT_ADDRESS_DISPLAY =
  CONTACT_ADDRESS_LINE || `${CONTACT_CITY}, Nederland`;
...
const BUILD_DATETIME_FORMATTED = new Date(BUILD_TIMESTAMP).toLocaleString(
  "nl-NL",
  {
    year: "numeric",
    month: "short",
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      // Explicit SVG + PNG fallbacks improves cross-browser favicon reliability.
    ...
    <html lang="nl" dir="ltr">
      <head>
        ...
        <link
          ...
          href="/guides/rss.xml"
          title="Your AI Worker - Guides"
        />
        <link
          rel="alternate"
          type="text/plain"
          href="/terms.txt"
          title="Algemene voorwaarden (tekst)"
        />
        <link
          rel="alternate"
          type="text/plain"
          href="/privacy.txt"
          title="Privacybeleid (tekst)"
        />
        <link
          rel="search"
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-slate-600 sm:gap-4">
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50/80 px-3 py-1.5 transition-colors hover:border-slate-300 hover:bg-slate-50">
              ...
              <span className="font-medium text-slate-700">
                Gevestigd in {CONTACT_CITY}
              </span>
            </span>
            {/* Dutch Business Badge */}
            <span
              className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50/80 px-3 py-1.5 transition-colors hover:border-slate-300 hover:bg-slate-50"
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 text-sm text-slate-600">
        <div className="grid gap-10 md:grid-cols-[1.3fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-slate-600">
              Plan een intake van 20 minuten en ontvang binnen 1 werkdag een
              concreet voorstel.
            </p>
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                aria-label="OpenClaw"
                referrerPolicy="strict-origin-when-cross-origin"
                title="OpenClaw - agent runtime (opent in nieuw tabblad)"
        ...
        <div className="mt-10 grid gap-6 border-t border-slate-200 pt-6 text-xs text-slate-400 sm:grid-cols-[1fr_auto] sm:items-start">
          <div className="flex flex-col gap-2">
            <p>
              © {new Date().getFullYear()} Your AI Worker. Alle rechten
              voorbehouden.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <p className="text-center text-[11px] text-slate-400">
            ...
            <a
              ...
              rel="noreferrer"
              referrerPolicy="strict-origin-when-cross-origin"
              className="inline-flex items-center gap-0.5 text-slate-500 underline underline-offset-2 transition-colors hover:text-slate-700"
              title="Next.js (opent in nieuw tabblad)"
            >
              Next.js
            ...
            <a
              ...
              referrerPolicy="strict-origin-when-cross-origin"
              className="inline-flex items-center gap-0.5 text-slate-500 underline underline-offset-2 transition-colors hover:text-slate-700"
              title="React (opent in nieuw tabblad)"
            >
              React
              <ExternalLink className="h-2.5 w-2.5" aria-hidden="true" />
            </a>
            ...
            <a
              ...
              referrerPolicy="strict-origin-when-cross-origin"
              className="inline-flex items-center gap-0.5 text-slate-500 underline underline-offset-2 transition-colors hover:text-slate-700"
              title="Tailwind CSS (opent in nieuw tabblad)"
            >
              Tailwind CSS
              <ExternalLink className="h-2.5 w-2.5" aria-hidden="true" />
            </a>{" "}
            ...
            <a
              ...
              referrerPolicy="strict-origin-when-cross-origin"
              className="inline-flex items-center gap-0.5 text-slate-500 underline underline-offset-2 transition-colors hover:text-slate-700"
              title="OpenClaw (opent in nieuw tabblad)"
            >
              OpenClaw
              <ExternalLink className="h-2.5 w-2.5" aria-hidden="true" />
            </a>
