...
const UseCaseDetailPage: React.FC<UseCaseDetailPageProps> = async (props) => {
  ...
  const breadcrumbJsonLd = buildBreadcrumbJsonLd([
    ...
    { name: "Toepassingen", url: `${siteUrl}/use-cases` },
    { name: useCase.title, url: `${siteUrl}/use-cases/${useCase.slug}` },
  ])
  return (
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 p-8 text-white">
              ...
              <div className="mt-6 flex flex-col gap-3">
                <a href="/contact" className="rounded-lg bg-white px-6 py-3 text-center text-sm font-medium text-slate-900 hover:bg-slate-100 transition-colors" >
                  Plan een intake
                </a>
                <a href="/pricing" className="rounded-lg border border-white/30 px-6 py-3 text-center text-sm font-medium text-white hover:bg-white/10 transition-colors" >
                  Bekijk packages
                </a>
              </div>
            </div>
        ...
        <div className="mt-12">
          <a href="/use-cases" className="text-sm font-medium text-slate-900 underline"> Terug naar toepassingen </a>
        </div>
      </section>
    </>
  )
