...
export const metadata: Metadata = {
  ...
  description:
    "Plan een intake, stel je vraag of vraag een voorstel aan. Binnen 1 werkdag reactie.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Bespreek je workflow, scope en planning. Binnen 1 werkdag een eerste reactie.",
  ...
  twitter: {
    ...
    description:
      "Vraag een intake of voorstel aan voor AI-automatisering. Binnen 1 werkdag reactie, heldere scope.",
    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-4 py-20">
        ...
        <p className="mt-4 text-slate-600">
          Plan een intake, stel een vraag, of vraag een voorstel aan. Je krijgt
        ...
        <div className="mt-10">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Vertel kort wat je wil automatiseren. Hoe concreter, hoe sneller
              we kunnen scopen.
            </p>
            <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">
              ...
              <p className="mt-1 text-slate-600">
                Plan een intake van 20 minuten. Je krijgt binnen 1 werkdag
                reactie en een voorstel met scope en planning.
              </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Your AI Worker, gevestigd in Amsterdam
                </p>
              </div>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:p-8">
              ...
              <ol className="mt-4 space-y-3 text-sm text-slate-700">
                <li className="flex gap-3">
                  ...
                  <span>
                    We nemen je aanvraag door en stellen 2 tot 5
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Je krijgt een voorstel met scope, planning, integraties en
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Na akkoord bouwen we de agent, testen met echte cases en
                    doen we een korte handover.
                  </span>
                </li>
              </ol>
            </div>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 p-6 text-white sm:p-8">
              <h2 className="text-lg font-semibold">
                Checklist voor een snelle intake
              </h2>
              <ul className="mt-4 space-y-2 text-sm text-white/80">
                <li className="flex items-start gap-2">
                  <span
                    aria-hidden="true"
                    className="mt-0.5 inline-flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-emerald-400/20 text-emerald-300"
                  >
                    <svg
                  ...
                  <span>
                    Voorbeeld van een echte case (e-mail, chat, ticket)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span
                  ...
                  <span>
                    Welke tool is bron van waarheid (CRM, inbox, sheets)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span
