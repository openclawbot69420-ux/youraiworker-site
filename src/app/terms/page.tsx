      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
        ...
        <div className="mt-8 grid gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-600">
          ...
          <p>
            ...
            Bij verschillen tussen dit document en een ondertekend voorstel of overeenkomst, geldt de ondertekende
            overeenkomst.
          </p>
          <p>
            <span className="font-semibold text-slate-800">Download:</span>{" "}
            <a className="underline underline-offset-2 hover:text-slate-900" href="/terms.txt">
              /terms.txt
            </a>
          </p>
        </div>
        ...
        <section className="mt-10 grid gap-8">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              ...
              <a className="underline underline-offset-2 hover:text-slate-900" href="/security">
                /security
              </a>
              .
            </p>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              ...
              <a className="underline underline-offset-2 hover:text-slate-900" href="/privacy">
                /privacy
              </a>
              .
            </p>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              We leveren zorgvuldig, maar aansprakelijkheid is beperkt tot wat redelijk is en wat in het voorstel is
              afgesproken.
            </p>
          </div>
