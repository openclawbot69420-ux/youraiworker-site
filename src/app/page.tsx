        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <p className="mt-2 text-xs leading-relaxed text-slate-500">
            ...
            <p className="mt-3 max-w-xl text-sm text-slate-500">
              ...
              <span className="text-slate-600"> Reactie binnen 1 werkdag (CET/Amsterdam).</span>
            </p>
            <dl
          ...
          {/* Risk reversal badge - builds trust by reducing perceived risk */}
          <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50/80 px-3 py-1.5 text-xs font-medium text-emerald-800">
            <svg
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            {[
              ...
              <div
                key={stat.label}
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs text-slate-600 shadow-sm transition-colors hover:border-slate-300 hover:bg-slate-50"
              title={stat.title}
              >
      ...
      <section id="intake" className="mx-auto max-w-6xl px-4 py-16">
        <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 px-6 py-14 text-white sm:px-12">
          ...
          <p className="mt-4 max-w-2xl text-white/70">
            Plan een korte intake. Je krijgt binnen 1-2 werkdagen een concreet voorstel met scope,
