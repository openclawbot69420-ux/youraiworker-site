        ...
        <div className="container">
          <div className="card">
            <div className="text-center">
              ...
              <p className="label">Temporaire storing</p>
              <h1 className="title">Onderbreking</h1>
              <p className="desc">
                Er ging iets mis bij het laden van de pagina. Dit ligt aan ons, niet aan jou. Je gegevens zijn veilig. Probeer het opnieuw.
              </p>
