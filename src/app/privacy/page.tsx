    ...
    <main className="mx-auto max-w-4xl px-4 py-20">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-sm text-slate-700">
              Geen verkoop of deling van persoonsgegevens met derden.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              Via het contactformulier kunnen we je naam, e-mailadres, bedrijfsnaam en bericht
              ontvangen. We gebruiken deze gegevens uitsluitend om je aanvraag te behandelen en
              eventuele opvolging te doen.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              ...
              gegevens niet voor verkoop aan derden en delen persoonsgegevens niet met derde
              partijen.
            </p>
          </div>
      ...
      <section className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-sm text-slate-600">
          Neem contact met ons op als je vragen hebt over gegevensverwerking, bewaartermijnen of
          je privacyrechten. We reageren zo snel mogelijk.
        </p>
