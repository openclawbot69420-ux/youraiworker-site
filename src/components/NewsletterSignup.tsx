...
export const NewsletterSignup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Success state (demo - in production, actually submit to your backend)
    setStatus("success")
    setMessage("Je bent aangemeld voor updates over AI-automatisering")
    setEmail("")
  ...
  return (
    <section
      id="nieuwsbrief"
      className="border-y border-slate-200/70 bg-gradient-to-br from-slate-50 to-slate-100"
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-600">
              Ontvang elke 2 weken een korte update met: nieuwe use-cases,
              implementatietips, en wat we leren uit productie deployments.
            </p>
            <p className="mt-2 text-xs text-slate-500">
              Geen spam. Uitschrijven kan altijd. Alleen relevante content.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <p className="text-xs leading-relaxed text-slate-500">
                ...
                <a
                  href="/privacy"
                  className="underline underline-offset-2 transition-colors hover:text-slate-700"
                >
                  privacybeleid
                </a>
